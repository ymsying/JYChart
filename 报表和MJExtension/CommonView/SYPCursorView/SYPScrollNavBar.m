...
@implementation SYPScrollNavBar
...
- (void)setRootScrollView:(SYPRootScrollView *)rootScrollView{
...
- (void)buttonClick:(UIButton *)button{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"updateExcelHeadFrame" object:nil userInfo:nil];
...
- (void)setSelectItemWithIndex:(NSInteger)index{
    ...
    if (!self.isGraduallyChangFont) {
        ...
        _oldItem = _currectItem;
        _currectItem.selected = NO;
        _currectItem.backgroundColor = [UIColor clearColor];
