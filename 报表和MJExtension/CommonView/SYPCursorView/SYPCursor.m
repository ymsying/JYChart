...
@property (nonatomic, strong) SYPSortItemView   *sortItmView;
...
- (SYPSortItemView *)sortItmView{
    if (!_sortItmView) {
        _sortItmView = [[SYPSortItemView alloc]init];
...
- (void)setTitles:(NSArray *)titles{
    ...
    [[SYPItemManager shareitemManager] setSortItemView:self.sortItmView];
